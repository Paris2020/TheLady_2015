...
<div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  <?php if (!$teaser): ?>
    <article class="events-list-article">
      <div class="left">
        <div class="related-events">
          <h2>Related Events</h2>
          <?php
            $views_block = module_invoke('views','block_view','latest_events_posts-block');
      ...
      <div class="right">
        ...
        <div class="events-body" <?php print $content_attributes; ?>>
